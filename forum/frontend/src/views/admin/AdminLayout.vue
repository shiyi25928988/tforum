<template>
  <el-container style="min-height: 100vh">
    <el-aside width="200px" style="background: #304156">
      <div style="padding: 20px; color: #fff; font-size: 18px; font-weight: 600; text-align: center">
        Admin
      </div>
      <el-menu
      ...
      >
        ...
        <el-menu-item index="/admin/nav">
          <el-icon><Menu /></el-icon><span>导航栏管理</span>
        </el-menu-item>
...
import { DataAnalysis, User, Document, ChatDotRound, Folder, Reading, PriceTag, Coin, Back, Menu, MagicStick } from '@element-plus/icons-vue'
